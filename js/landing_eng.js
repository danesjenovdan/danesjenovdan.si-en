(function () {
  ...
  $.getJSON('http://djapi.knedl.si/djndLanding/ANG_projects/3/')
    .done(function (json) {
      if (json.status != 'OK') {
        return;
      }
  ...
  $.getJSON('http://djapi.knedl.si/djndLanding/ANG_parlameter/1/')
    .done(function (data) {
  ...
  $.getJSON('http://djapi.knedl.si/djndLanding/ANG_news/4/')
    .done(function (json) {
      if (json.status != 'OK') {
        return;
      }
